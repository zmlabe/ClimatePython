...
plt.plot(years,polar,linewidth=2.5,color='k',marker='o',
...
l = plt.legend(fontsize=10,loc='upper center',bbox_to_anchor=(0.5,0.15),
...
plt.xlim([1982,2019])
plt.ylim([-3,3])
plt.text(1982,2.5,r'\textbf{[a]}',fontsize=12,color='dimgrey')
